 ...
 */
#define FLASH_SIZE					0x1000000		/* QspiFlash 共16M */
#define BIN_SIZE					0x0800000		/* 程序空间大小，8M */
#define BIN_START_ADDRESS			0x0000000
#define DATA_START_ADDRESS			0x0800000		/* 留有8M的星库存储空间, 角距的dist20final */
...
void load_star(u8 *read_buffer, u32 length){
	...
	u32 flash_address = DATA_START_ADDRESS;
