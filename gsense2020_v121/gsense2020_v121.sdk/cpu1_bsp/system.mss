...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra -DUSE_AMP=1 -DUNDEFINE_FILE_OPS
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = BRAM_CTL1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi_config
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = spi_config_0
END
