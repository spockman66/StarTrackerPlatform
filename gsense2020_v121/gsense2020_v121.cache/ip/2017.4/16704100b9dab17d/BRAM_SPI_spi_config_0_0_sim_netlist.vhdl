...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bram_rd is
  ...
  attribute SOFT_HLUTNM of \counter2[4]_i_6\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter2[4]_i_8\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \ram_addr[31]_i_10\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ram_addr[31]_i_11\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ram_addr[31]_i_16\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ram_rd_data_reg[31]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \read_counter[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \read_counter[8]_i_3\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of spi_data_i_8 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of spi_data_i_9 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of spi_write_reg1_i_2 : label is "soft_lutpair6";
...
\ram_addr[31]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\ram_addr[31]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\spi_config_fsm[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
spi_read_i_3: unisim.vcomponents.LUT6
    generic map(
