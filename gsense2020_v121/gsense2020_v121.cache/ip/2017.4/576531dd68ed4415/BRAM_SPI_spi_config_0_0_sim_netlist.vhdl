...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bram_rd is
  ...
  signal \^ram_addr[31]\ : STD_LOGIC_VECTOR ( 30 downto 0 );
  ...
  attribute SOFT_HLUTNM of \counter2[4]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter2[4]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \loc_cnt[0]_i_6\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ram_addr[31]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ram_addr[31]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of ram_en_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of ram_en_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \read_counter[4]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \read_counter[4]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of spi_read_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of spi_write_reg1_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sys_rst_n_i_4 : label is "soft_lutpair5";
begin
  \FSM_sequential_pwr_up_fsm_reg[2]_0\ <= \^fsm_sequential_pwr_up_fsm_reg[2]_0\;
  all_done <= \^all_done\;
  fpga_en <= \^fpga_en\;
  \ram_addr[31]\(30 downto 0) <= \^ram_addr[31]\(30 downto 0);
  ram_en <= \^ram_en\;
  ram_we(0) <= \^ram_we\(0);
  spi_data <= \^spi_data\;
  spi_read <= \^spi_read\;
...
\FSM_sequential_spi_config_fsm[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00B8FFB8"
    )
        port map (
...
ram_addr0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => \^ram_addr[31]\(3 downto 2),
...
\ram_addr0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^ram_addr[31]\(7 downto 4)
    );
\ram_addr0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^ram_addr[31]\(11 downto 8)
    );
\ram_addr0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^ram_addr[31]\(15 downto 12)
    );
\ram_addr0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^ram_addr[31]\(19 downto 16)
    );
\ram_addr0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^ram_addr[31]\(23 downto 20)
    );
\ram_addr0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^ram_addr[31]\(27 downto 24)
    );
\ram_addr0_carry__6\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2 downto 0) => \^ram_addr[31]\(30 downto 28)
    );
...
\ram_addr[31]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\ram_addr[31]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\ram_addr[31]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\ram_addr[31]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_config_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_2\ : label is "soft_lutpair6";
begin
...
config_module: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bram_rd
     port map (
      ...
      fpga_en => fpga_en,
      \ram_addr[31]\(30 downto 0) => Q(30 downto 0),
      ram_en => ram_en,
...
spi_config_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_config_v1_0_S00_AXI
     port map (
      Q(30 downto 0) => ram_addr(30 downto 0),
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
      all_done => all_done,
