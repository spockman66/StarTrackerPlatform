...
HD_PWD='D:/xilinx_2017/Projects/gsense2020_v121/gsense2020_v121.runs/BRAM_SPI_receiver_hw_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_SPI_receiver_hw_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_SPI_receiver_hw_0_0.tcl
