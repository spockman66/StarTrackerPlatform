...
HD_PWD='D:/xilinx_2017/Projects/gsense2020_v121/gsense2020_v121.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_SPI_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BRAM_SPI_wrapper.tcl -notrace
