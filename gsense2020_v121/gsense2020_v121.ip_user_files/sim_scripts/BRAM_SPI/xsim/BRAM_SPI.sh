...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_15 -L fifo_generator_v13_2_1 -L axi_data_fifo_v2_1_14 -L axi_crossbar_v2_1_16 -L axi_protocol_converter_v2_1_15 -L axi_clock_converter_v2_1_14 -L blk_mem_gen_v8_4_1 -L axi_dwidth_converter_v2_1_15 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BRAM_SPI xil_defaultlib.BRAM_SPI xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BRAM_SPI -key {Behavioral:sim_1:Functional:BRAM_SPI} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/xilinx_2017/Vivado/2017.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BRAM_SPI.wdb xsim.dir)
